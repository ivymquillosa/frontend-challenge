    ...
    create(context) {
        ...
        return {
            Program(node) {
                ...
                let fixed = 0;
                for (const { source, reason, ruleId, fatal, line, column, position, } of messages) {
                    ...
                    context.report({
                        ...
                        loc: {
                            line,
                            column: column - 1,
                            start: start && Object.assign(Object.assign({}, start), { column: start.column - 1 }),
                            end: end && Object.assign(Object.assign({}, end), { column: end.column - 1 }),
                        },
                        node,
