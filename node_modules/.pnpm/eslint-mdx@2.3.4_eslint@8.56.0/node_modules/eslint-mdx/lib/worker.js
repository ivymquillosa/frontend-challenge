...
function isExpressionStatement(statement) {
    (0, assert_1.ok)(!statement || statement.type === 'ExpressionStatement');
}
        ...
        visit(root, node => {
                    ...
                    ? node.children.reduce((acc, child) => {
                        ...
                        if (child.data && 'estree' in child.data && child.data.estree) {
                            ...
                            if (child.type === 'mdxTextExpression') {
                                ...
                                const expressionContainer = Object.assign(Object.assign({}, normalizeNode(start, end)), { type: 'JSXExpressionContainer', expression: expression || Object.assign(Object.assign({}, normalizeNode(start + 1, end - 1)), { type: 'JSXEmptyExpression' }) });
            ...
            function handleNode(node) {
                ...
                if (node.type === 'code') {
                    ...
                    const mdxJsxCode = Object.assign(Object.assign({}, normalizeNode(start, end)), { type: 'MDXCode', lang,
                        meta,
                        value });
                    return mdxJsxCode;
                }
                if (node.type === 'heading') {
                    const { depth } = node;
                    const mdxJsxHeading = Object.assign(Object.assign({}, normalizeNode(start, end)), { type: 'MDXHeading', depth, children: handleChildren(node) });
                    return mdxJsxHeading;
                }
                if (node.type === 'text') {
                    const jsxText = Object.assign(Object.assign({}, normalizeNode(start, end)), { type: 'JSXText', value: node.value });
                    return jsxText;
                }
                ...
                if ('name' in node && node.name) {
                    ...
                    const jsxEl = Object.assign(Object.assign({}, normalizeNode(nodeStart, nodeEnd)), { type: 'JSXElement', openingElement: {
                            ...
                            attributes: node.attributes.map(attr => {
                                ...
                                return Object.assign(Object.assign({}, normalizeNode(attrStart, lastAttrOffset + 1)), { type: 'JSXAttribute', name: Object.assign(Object.assign({}, attrNamePos), { type: 'JSXIdentifier', name: attrName }), value: typeof attr.value === 'string'
            ...
            if (expression) {
                body.push(Object.assign(Object.assign({}, (0, helpers_1.normalizePosition)(node.position)), { type: 'ExpressionStatement', expression: expression }));
            }
